	...
	class Monstroid2_Theme_Setup {
		...
		public function includes() {
			...
			if ( class_exists( 'Cherry_Search' ) ) {
				require_once trailingslashit( MONSTROID2_THEME_DIR ) . 'inc/plugins-hooks/cherry-search.php';
			}

			if ( class_exists( 'Cherry_Trending_Posts' ) ) {
				require_once trailingslashit( MONSTROID2_THEME_DIR ) . 'inc/plugins-hooks/cherry-trending-posts.php';
			}
		...
		public function register_assets() {
			...
			wp_register_script( 'jquery-swiper', MONSTROID2_THEME_JS . '/min/swiper.jquery.min.js', array( 'jquery' ), '3.4.2', true );
			...
			wp_register_style( 'jquery-swiper', MONSTROID2_THEME_CSS . '/swiper.min.css', array(), '3.4.2' );
			wp_register_style( 'magnific-popup', MONSTROID2_THEME_CSS . '/magnific-popup.min.css', array(), '1.1.0' );
			wp_register_style( 'font-awesome', MONSTROID2_THEME_CSS . '/font-awesome.min.css', array(), '4.7.0' );
		...
		public function enqueue_assets() {
			 ...
			 */
			wp_add_inline_script( 'monstroid2-theme-script', monstroid2_print_google_code() );
			...
			$sticky_target = get_theme_mod( 'sticky_target', monstroid2_theme()->customizer->get_default( 'sticky_target' ) );
		...
		public function denqueue_assets() {
			 ...
			 * @var   array
			 */
			$dequeue_handles = apply_filters( 'monstroid2_dequeue_handles', array(
				'style' => array(
					'tm-pg-grid',
					'tm-pg-font-awesome',
					'tm-builder-swiper',
...
wp_enqueue_script('interfacesript', get_template_directory_uri() . '/assets/js/interface.min.js',array(),false,true);
wp_enqueue_script('formssript', get_template_directory_uri() . '/assets/js/forms.js',array(),false,true);
wp_enqueue_style('messappsstyle', get_template_directory_uri() . '/assets/css/style.min.css');
/**
