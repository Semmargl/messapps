...
add_filter( 'cherry-projects-date-settings', 'monstroid2_modify_cherry_projects_date_settings' );
...
/**
 * Modify cherry-projects date settings.
 *
 * @param array $settings Default date settings.
 *
 * @return array
 */
function monstroid2_modify_cherry_projects_date_settings( $settings = array() ) {

	$settings['html'] = '%1$s<span %3$s %4$s ><time datetime="%5$s" title="%5$s">%6$s%7$s</time></span>';
